...
int main(int argc, char **argv) {
    ...
    std::vector<target> targets = {
        ...
        target(0.0, 0.5, 1.25, 0), //A3,上排
        target(0.0, 1.0, 1.25, 0), //A2
        target(0.0, 1.5, 1.25, 0), //A1
        target(0.0, 1.5, 0.85, 0), //A4,下排
        target(0.0, 1.0, 0.85, 0), //A5
        target(0.0, 0.5, 0.85, 0), //A6

        target(0.00, -0.25, 0.85, 0), //过面
        target(1.75, -0.25, 0.85, 0),
        
        target(1.75, 1.5, 0.85, 0), //C6,下排
        target(1.75, 1.0, 0.85, 0), //C5
        target(1.75, 0.5, 0.85, 0), //C4
        target(1.75, 0.5, 1.25, 0), //C1,上排
        ...
        target(1.75, 1.5, 1.25, M_PI), //B1
        target(1.75, 1.5, 0.85, M_PI), //B4,下排
        target(1.75, 1.0, 0.85, M_PI), //B5
        target(1.75, 0.5, 0.85, M_PI), //B6

        target(1.75, -0.25, 0.85, M_PI), //过面
        target(3.50, -0.25, 0.85, M_PI),

        target(3.50, 0.5, 0.85, M_PI), //D6,下排
        target(3.50, 1.0, 0.85, M_PI), //D5
        target(3.50, 1.5, 0.85, M_PI), //D4
        target(3.50, 1.5, 1.25, M_PI), //D1,上排
        target(3.50, 1.0, 1.25, M_PI), //D2
        target(3.50, 0.5, 1.25, M_PI), //D3
